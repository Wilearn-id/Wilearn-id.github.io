...
const arrow = document.getElementById("agenda_arrow");
const menu = document.querySelector(".menu_agenda");
const agendaChilds=document.getElementById("agenda_childs");

menu.addEventListener("click", () => {
arrow.classList.toggle("agenda_arrow_active");
